...
var crawl = function() {
	var url = "http://www.marketwatch.com/newsviewer/mktwheadlines"
	var options = {
		url: url,
		method: 'POST',
		headers: {
		...
		body: 'topstories=false&rtheadlines=false&pulse=true&commentary=false&video=false&premium=false&blogs=false&topic=All+Topics'
	};
	...
	request(options, function (error, response, body) {
		if (response && 200 === response.statusCode) {
			jsdom.env(body, function (err, window) {
				...
				var news = document.querySelectorAll(".expandable")
				if (news) {
